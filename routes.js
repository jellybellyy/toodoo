module.exports = (app, allModels) => {
    const usersControllerCallback = require('./controllers/users_controller')(allModels);
    ...
    const todolistControllerCallback = require('./controllers/todolist_controller')(allModels);
